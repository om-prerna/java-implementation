...
public class LRUCache<K,V> {
    ...
    private HashMap<Integer, CacheNode<K, V>> cacheMap;
    ...
    public LRUCache(int capacity){
        ...
        cacheMap = new HashMap<Integer, CacheNode<K, V>>();
    ...
    void removeLastNode(){
        CacheNode<K, V> nodeToRemove = tail.pre;
        removeNode(nodeToRemove);
        cacheMap.remove(nodeToRemove.key);
    }

    void  removeNode(CacheNode temp){
        if(temp.next != null)
